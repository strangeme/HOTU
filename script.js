...
const translations = {
  ...
  en: {
    ...
    contact: {
      ...
      email: "If you are interested in learning more, please do not hesitate to contact us at <br> Info@hotucapital.com",
...
function updateLanguageButton() {
  ...
  languageButton.textContent = currentLang === 'zh' ? '中/EN' : 'EN/中';
}
